...
class SupportGraphRunner:
    ...
    def _initial_state(
        ...
        *,
        ...
        initial_state: dict[str, Any] = {
            ...
            "system_statuses": [],
            "pending_attachments": list(pending_attachments or []),
            "kb_rag_enabled": kb_rag_enabled,
        }
        if troubleshoot_state:
            initial_state["troubleshoot"] = dict(troubleshoot_state)
        if active_ticket_number:
            initial_state["active_ticket_number"] = active_ticket_number
        if history:
    ...
    def _result_from_state(final_state: dict[str, Any]) -> GraphTurnResult:
        ...
        return GraphTurnResult(
            ...
            troubleshoot_state=final_state.get("troubleshoot"),
            deflection=final_state.get("troubleshoot_deflection"),
        )
