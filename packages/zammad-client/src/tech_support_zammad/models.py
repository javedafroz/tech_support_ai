...
class ZammadAttachmentInput(BaseModel):
    model_config = ConfigDict(populate_by_name=True)

    filename: str
    data: str
    mime_type: str = Field(validation_alias="mime-type", serialization_alias="mime-type")
...
class TicketArticleInput(BaseModel):
    ...
    attachments: list[ZammadAttachmentInput] | None = None
